                    ...
                    <div className="absolute inset-0 bg-white shadow-md lg:p-10 p-5 flex flex-col">
                        <div className="flex">
                            <div className='text-xl'>
                                <Link href='/'>Bijon Setyawan Raya</Link>
                            </div>
                            <button
                        ...
                        <div className="mt-auto grid grid-cols-1 md:grid-cols-2">
                            <div>
                                <Link href="/" onClick={toggleMenu} className="block mb-2 text-6xl hover:text-slate-400 hover:underline">Home</Link>
                                <Link href="/about" onClick={toggleMenu} className="block mb-2 text-6xl hover:text-slate-400 hover:underline">About</Link>
                                <Link href="/experience" onClick={toggleMenu} className="block mb-2 text-6xl hover:text-slate-400 hover:underline">Experience</Link>
                            </div>
                            <div>
