    ...
    return (
        <div className="hidden lg:w-1/4 lg:fixed h-[100vh] lg:p-10 lg:flex lg:flex-col border-r border-gray-300">
            ...
            <ul className="mt-auto">
                <li className="text-xl hover:text-slate-400 hover:underline w-fit"><Link href="/posts">Posts</Link></li>
                <li className="text-xl hover:text-slate-400 hover:underline w-fit"><Link href="/about">About</Link></li>
                <li className="text-xl hover:text-slate-400 hover:underline w-fit"><Link href="/experience">Experience</Link></li>
            </ul>
            <div className="py-2 px-5 my-5 text-xl w-fit rounded-full border border-2 hover:text-white hover:bg-black hover:border-black"><Link href="/works">See my works</Link></div>
            <div className="flex gap-2">
                ...
                <Link href="https://github.com/bsraya" className="hover:text-slate-400">
                ...
                <Link href="https://linkedin.com/in/bijonsetyawan" className="hover:text-slate-400">
