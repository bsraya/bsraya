...
img: "https://images.unsplash.com/photo-1525540122998-1bcbd8090980?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80"
...
![MSE values produced by MBGD with different batch sizes](/images/posts/mini-batch-gradient-descent/mse.png "MSE values produced by MBGD with different batch sizes")
...
![TSS values produced by MBGD with different batch sizes](/images/posts/mini-batch-gradient-descent/rss.png "TSS values produced by MBGD with different batch sizes")
...
![Regression Lines](/images/posts/mini-batch-gradient-descent/regression-lines.png "Regression Lines")
...
![Regression Line Movements](/images/posts/mini-batch-gradient-descent/mbgd.gif "Regression Line Movements")
...
![The movement of the intercept and the coefficient variabels on a contour map](/images/posts/mini-batch-gradient-descent/contour.png "The movement of the intercept and the coefficient variabels on a contour map")
