...
![The iris dataset regression line with Scikit](/images/posts/batch-gradient-descent/scikit-lr.png "The iris dataset regression line with Scikit")
...
![BGD Loss Function Graph](/images/posts/batch-gradient-descent/iterations.png "BGD Loss Function Graph")
...
![Regression line changes over time](/images/posts/batch-gradient-descent/regression-lines.png "Regression line changes over time")

Let's animate the movement of the regression lines.

![Regression line animation](/images/posts/batch-gradient-descent/bgd.gif "Regression line animation")

Now, let's see how the movement of the intercept and the coefficient variabels on a contour map.

![The movement of the intercept and the coefficient variabels on a contour map](/images/posts/batch-gradient-descent/contour.png "The movement of the intercept and the coefficient variabels on a contour map")
