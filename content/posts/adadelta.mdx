...
where $E[\Delta \theta^2]_{t-1}$ is the running average of the squared parameter updates up to time $t-1$.
...
where $E[g^2]_t$ is the running average of the squared gradients up to time $t$.
