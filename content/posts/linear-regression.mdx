...
However, we aren't gonna keep on guessing, and it's better to use an iterative method such as Gradient Descent algorithm.
...
The series covers the intuition behind Gradient Descent, the math behind it, and its implementation in Python.
