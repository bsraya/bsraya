...
Previously, I mentioned that $\hat{y} = \beta_0 + \beta_1x$ is used to express the regression line.
To be fair, we can't just look at the data and say, _"Ah ha! I can tell that $\beta_0$ is $0$ and $\beta_1$ is $0$."_
