...
5. The smaller the MSE, the better the regression line. The larger the MSE, the worse the regression line.
...
3. Chris McCormick. _Gradient Descent Derivation_. https://mccormickml.com/2014/03/04/gradient-descent-derivation/
4. G. Sanchez & E. Marzban. _All Models are Wrong_. https://allmodelsarewrong.github.io/gradient.html