...
![A quarter of a circle with random data points](/assets/posts/monte-carlo-experiments/quarter_circle.png "A quarter of a circle with random data points")
...
![A whole circle with random data points](/assets/posts/monte-carlo-experiments/whole_circle.png "A whole circle with random data points")
