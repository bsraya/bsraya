...
Note that the term __loss Function__ and __cost function__ are used interchangeably.
We should know that __loss unction__ is the error value of a single data point, while __cost function__ is the average of all loss functions of all data points.
...
$$
  \theta_{i} = \theta_i - \alpha \cdot \frac{\partial}{\partial \theta_i} J(\theta)
$$
...
$$
    \begin{aligned}
        \frac{\partial}{\partial \theta_0} J(\theta) = \frac{1}{N} \sum_{i=1}^N (f(x) - y_i) \\
        \frac{\partial}{\partial \theta_1} J(\theta) = \frac{1}{N} \sum_{i=1}^N (f(x) - y_i) x
    \end{aligned}
$$
