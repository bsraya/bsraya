...
![The intercept and the coefficient variable on a contour map](/images/posts/mini-batch-gradient-descent/contour.png "The intercept and the coefficient variable on a contour map")
