...
1. $V$ is a matrix containing the atrributes of the songs we collected from Spotify API.
2. $W$ is a matrix containing the latent features of the songs.
3. $H$ is a matrix containing the coefficients of the latent features.
4. $n$ is the number of songs.
5. $m$ is the number of features.
6. $p$ is the number of latent features.
