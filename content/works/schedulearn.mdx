...
This page is not finished yet. However, I just some of gists of the project.
In the coming weeks, I will complete this page with more details.
...
def fifo(required_gpus: int) -> dict | None:
    for server in ['gpu3', 'gpu4', 'gpu5']:
        ...
        available_gpus = ... # include only GPUs with 90% VRAM usage
