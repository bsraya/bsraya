---
title: Local Personal Retrieval-Augmented Generation
description: Developing a local RAG system using Llama Index
date: 2024-05-30
tag: LLM
image: /assets/works/local-personal-rag/thumbnail.png
type: Work
---

In this post, I am going to elaborate on how I made my own local
Retrieval-Augmented Generation (RAG) system using Llama Index and Llama 3.

![Local RAG prompt](/assets/works/local-personal-rag/prompt.png)
...
![1500 chunk size, and 100 chunk overlap.](/assets/works/local-personal-rag/chunk-visualization.png)

[https://chunkviz.up.railway.app/](https://chunkviz.up.railway.app/) can help visualize the chunking process.

## Observations

![Prompt 2: "What skills required for those job descriptions?"](/assets/works/local-personal-rag/prompt2.png)

![Prompt 3: "What are common responsibilities these jobs have?"](/assets/works/local-personal-rag/prompt3.png)

![Prompt 4: "As a senior HR, how would you rate my resume?"](/assets/works/local-personal-rag/prompt4.png)
