...
image: /assets/works/ai-coding-assistant/thumbnail.jpg
type: Work
---
...
In the project, I embed a Python Web Assembly compiler so that one should not have to send their code to the backend and
