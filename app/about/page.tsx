                ...
                <div className="flex flex-col gap-10 mb-10">
                    ...
                    <div className="font-baskervville max-w-prose leading-8 flex flex-col gap-10 text-lg">
                        <p>
                            ...
                            If you are interested to see what I have done? You could see my resume <ExternalLink url="/resume.pdf" text="here" /> or the projects that I have done <Link href="/works" className="underline">here</Link>.
                        </p>
