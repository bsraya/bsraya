                ...
                <div>
                    ...
                    <div className="flex flex-col gap-10">
                        <div>
                            ...
                            <p className="font-merriweather font-thin md:text-2xl text-xl mb-1">Fullstack Developer</p>
                            <p className="font-khula md:text-lg text-md text-slate-500">Faria Education Group - Taipei, Taiwan</p>
                        </div>
                        <div>
                            <p className="font-lalezar text-lg text-slate-500">February 2021 - December 2022</p>
                            <p className="font-merriweather font-thin md:text-2xl text-xl mb-1">Graduate Research Assistant</p>
                            <p className="font-khula md:text-lg text-md text-slate-500">National Tsing Hua University - Hsinchu, Taiwan</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-10">
                        <div>
                            ...
                            <p className="font-merriweather font-thin md:text-2xl text-xl mb-1">M. Sc. in Computer Science</p>
                            <p className="font-khula md:text-lg text-md text-slate-500">National Tsing Hua University - Hsinchu, Taiwan</p>
                        </div>
                        <div>
                            <p className="font-lalezar text-lg text-slate-500">September 2015 - January 2021</p>
                            <p className="font-merriweather font-thin md:text-2xl text-xl mb-1">B. Sc. in Computer Science</p>
                            <p className="font-khula md:text-lg text-md text-slate-500">National Tsing Hua University - Hsinchu, Taiwan</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-10">
                        <div>
                            ...
                            <p className="font-merriweather font-thin md:text-2xl text-xl mb-1">Civil IoT Taiwan 2018</p>
                            <p className="font-khula md:text-lg text-md text-slate-500">Third place - Taipei, Taiwan</p>
                        </div>
                    </div>
                </div>
            </div>
